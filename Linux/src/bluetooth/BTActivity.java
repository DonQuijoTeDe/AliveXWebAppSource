...
public class BTActivity extends JFrame {
    ...
    private void onUpdate(ArrayList<HashMap<String, String>> mlistSBTDevices) {
        ...
        System.out.println("UpdateLength: " + mlistSBTDevices.size());
    ...
    private void initUIComponent() {
        ...
        layout.setHorizontalGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup()
                        ...
                        .addComponent(BTDevicesScrollPane, GroupLayout.PREFERRED_SIZE, 240, GroupLayout.PREFERRED_SIZE))
                .addGap(20)
                .addGroup(layout.createParallelGroup()
    ...
    public static void main(String[] args) {
        ...
        try {
            /*
            There are three types of L&F, it depends on which systems you used
